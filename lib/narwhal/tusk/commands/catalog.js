...
Catalog.prototype.hasFallbackCatalog = function() {
    if(this.fallbackCatalog) return true;
    return false;
}

Catalog.prototype.getFallbackCatalog = function() {
    if(this.fallbackCatalog) return this.fallbackCatalog;
    return false;
}
...
Catalog.prototype.isPublished = function() {
    var catalog = this.getCatalog(false);
    return util.has(catalog, "location");
}
