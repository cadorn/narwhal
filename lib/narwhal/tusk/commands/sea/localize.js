...
dump(dependency.getLocator().getInfo());            
print(dependency.isSeaPackage());            
            
            if(dependency.getLocator().isNamedOnly() || dependency.isSeaPackage()) {
                ...
                if(dependency.getType()=="package") {
                    ...
                    info.using[dependency.getName()] = {
                        "catalog": "",
                        "location": "file://" + dependency.getPackage().getPath().join("").valueOf()
                    };
                } else
