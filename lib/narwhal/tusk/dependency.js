...
exports.Dependency = function (sea, parentPkg, name, info) {
...
//dump(info);        
    ...
    if(locator.getType()=="catalog") {
        ...
        if(!catalog.hasPackage(locator.getName())) {
            throw new TUSK.TuskError("Package '" +  + "' not found in catalog: " + locator.getUrl());
        }
        locator = catalog.getLocator(locator.getName());
    } else
