...
Sea.prototype.forEachDependency = function(callback, type, deep) {
    this.getSeaPackage().forEachDependency(callback, type, deep);
}
...
Sea.prototype.getPackagesPath = function() {
    ...
    return PACKAGE.Package(this.path).getPackagesPath();
}
