...
exports.load = function (prefixes, options) {
    ...
    var root = exports.read(prefixes, catalog, usingCatalog, uidCatalog, options);
...
exports.registerUsingPackage = function(locator, path) {
    ...
    var catalog = [
        exports.usingCatalog[id].descriptor
    ];
    catalog[0].directory = path;
    
    var analysis = {
        "javaPaths": exports.analysis.javaPaths,
        "libPaths": exports.analysis.libPaths
    };
    
    exports.analyze(analysis, catalog, exports.usingCatalog);
    if (packagesEngine) packagesEngine.analyze(analysis, catalog);

    exports.synthesize(analysis);
    if (packagesEngine) packagesEngine.synthesize(analysis);

    exports.analysis.javaPaths = analysis.javaPaths;
    exports.analysis.libPaths = analysis.libPaths;
...
exports.registerSystemPackages = function(paths) {
    ...
    var catalog = {};
    var root = exports.read(paths, catalog, exports.usingCatalog, exports.uidCatalog, {});

    exports.verify(catalog);
    exports.normalize(catalog);

    // splice new packages into catalog
    util.forEach(catalog, function(item) {
        if(!util.has(exports.catalog, item[0])) {
            exports.catalog[item[0]] = item[1];
        }
    });
    ...
    exports.analyze(analysis, order, exports.usingCatalog);
    if (packagesEngine) packagesEngine.analyze(analysis, order);
...
//                dependencyInfo = item[1];
                dependencyInfo = item[0];
                name = dependencyInfo.name;
                
                if(!Object.prototype.hasOwnProperty.call(usingCatalog, name)) {
//                    throw new Error("Dependency with name '"+name+"' not found in usingCatalog!");
//print("NOTICE: Dependency with name '"+name+"' not found in usingCatalog!");
                    continue;
                }
                packageDirectory = usingCatalog[name].directory;
/*
print("***********");
print(" ");
print("name: "+name);
...
//               !Object.prototype.hasOwnProperty.call(catalog, dependency)) {
              if(!Object.prototype.hasOwnProperty.call(catalog, dependency)) {
                queue.push([
...
exports.analyze = function analyze(analysis, catalog, usingCatalog) {
    analysis.libPaths = analysis.libPaths || [];
...
// HACK
    ...
    util.forEach(usingCatalog, function (info) {
...
exports.updateUsingCatalog = function(options, usingCatalog, uidCatalog, path, id, packageDatum) {
    ...
    if(!util.has(usingCatalog, id)) {
        usingCatalog[id] = {
            ...
            "libPath": path.join((packageDatum.directories && typeof packageDatum.directories.lib != "undefined")?packageDatum.directories.lib:"lib"),
            "directory": path,
            "packages": {},
