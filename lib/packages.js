...
exports.read = function read(prefixes, catalog, usingCatalog, uidCatalog, options) {
    ...
    prefixes.forEach(function(prefix) {
        exports.readUsing(options, usingCatalog, uidCatalog, fs.Path(prefix).join("using"));
    });

    if(system.sea && !util.has(system.sea, prefixes)) {
        exports.readUsing(options, usingCatalog, uidCatalog, fs.Path(system.sea).join("using"));
    }
...
exports.readUsing = function(options, usingCatalog, uidCatalog, basePath, subPath) {
    ...
    if(path.join("package.json").exists()) {
        ...
        path.listPaths().forEach(function(dir) {
            exports.readUsing(options, usingCatalog, uidCatalog, basePath, subPath.join(dir.basename()));
        });
    }
}
